...
interface-details section. `Node.Render`, `Tasks.otherOpenTasks`,
`CodeMode.Model`, `Tools.Task` and `codemode/sdk.js` agree with those decisions;
the projection/provider and task-selection tests above cover the tail boundary.
