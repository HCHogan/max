...
`src + app` is **44,806 effective Haskell lines**, down 7,821 from the initial
52,627 baseline. Owned production source totals **52,167** before installed SQL.
...
33,842 → **33,725** (−117); `src + app` is 44,908 → **44,806** (−102).
...
The measured core is therefore **33,725 lines including active SQL**. Owned
production source plus active SQL is **53,914 lines**; retained archival schema
