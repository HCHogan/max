...
module Max.Effects.TurnQuery (TurnQuery, resolveTurnResult, expandTurnTrace, expandTurnResult, runTurnQuery) where
...
import Max.DB.AgentTurn (expandJournalResult, resolveJournalResultValue)
